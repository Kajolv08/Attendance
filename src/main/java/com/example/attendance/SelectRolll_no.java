...
public class SelectRolll_no extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_rolll_no);
    ...
    private void load() {
        utils.sr = new StringRequest(Request.Method.GET, new URLs().ROLL_NUMBER_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                Log.i("", response);
                dataLoad(response);
                Toast.makeText(SelectRolll_no.this, ""+response, Toast.LENGTH_SHORT).show();
                utils.pd.dismiss();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(SelectRolll_no.this, ""+error.toString(), Toast.LENGTH_SHORT).show();
                utils.pd.dismiss();
            }
        });
